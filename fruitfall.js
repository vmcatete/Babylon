        ...
        var createScene = function () {
            ...
            camera.setTarget(new BABYLON.Vector3(40, 0, 00));
           // camera.inputs.removeByType("FreeCameraKeyboardMoveInput");
            ...
            Promise.all([
                loadCharacter(0, "Peach.babylon", new BABYLON.Vector3(80, 4.5, 0), new BABYLON.Vector3(15, 50, 15), spheres),
                loadCharacter(1, "Mario.babylon", new BABYLON.Vector3(0, 4.5, 0), new BABYLON.Vector3(25, 150, 25), spheres), 
                loadCharacter(2, "Luigi.babylon", new BABYLON.Vector3(55, 4.5, 0), new BABYLON.Vector3(25, 150, 25), spheres),
                loadCharacter(3, "Toad.babylon", new BABYLON.Vector3(30, 4.5, 0), new BABYLON.Vector3(25, 100, 25), spheres),      
                ]).then(() => {
                    playersReady=true;
        ...
        function loadCharacter(playerNum, mesh, position, scale, spheres) {
            var baseURL = "https://raw.githubusercontent.com/vmcatete/babylon/master/";
